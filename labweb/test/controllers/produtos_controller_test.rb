...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { categoria: @produto.categoria, descricao: @produto.descricao, nome: @produto.nome } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { categoria: @produto.categoria, descricao: @produto.descricao, nome: @produto.nome } }
